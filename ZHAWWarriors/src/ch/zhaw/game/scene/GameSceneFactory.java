...
import ch.zhaw.game.entity.Actor;
import ch.zhaw.game.entity.EntityClass;
import ch.zhaw.game.entity.Item;
import ch.zhaw.game.entity.Tile;
...
public class GameSceneFactory {
	...
	public static GameScene loadScene(ResourceManager resourceManager,
		...
		// create boundries
		scene.createMap(tiles.length() * 1024, 512);
